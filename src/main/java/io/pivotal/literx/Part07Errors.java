...
// 		Este me retorna el error que se genera en la entrada
...
//		Este es como un acumulador de error
		return  flux.onErrorResume(usuario -> Flux.just(User.SAUL, User.JESSE));
	}
